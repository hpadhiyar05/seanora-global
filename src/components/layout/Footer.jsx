...
const Footer = () => {
    ...
    return (
        <footer
            className="bg-white border-t border-black/5 pt-20 pb-10 mt-auto relative"
            style={{ overflow: 'clip', overflowClipMargin: '80px 0 0 0' }}
        >
            {/* Watermark — top overflows border, bottom clipped, fades out downward */}
            <div
                aria-hidden="true"
                style={{
                    position: 'absolute',
            ...
            >
                <span
                    style={{
                        fontFamily: 'inherit',
                        fontSize: 'clamp(88px, 13vw, 190px)',
                        fontWeight: 800,
                        ...
                        maskImage: 'linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.28) 50%, rgba(0,0,0,0.04) 100%)',
                        WebkitMaskImage: 'linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.28) 50%, rgba(0,0,0,0.04) 100%)',
            ...
            <div className="max-w-[1280px] mx-auto px-4 lg:px-12 relative z-10 w-full flex flex-col">
                ...
                >
                    ...
                    <div className="lg:col-span-5">
                        ...
                        <p className="text-[#1B1D1E]/60 font-medium leading-relaxed mb-8 text-[14px] max-w-[280px]">
                            Empowering businesses with transformative IT solutions, robust cloud systems, and cutting-edge software
                            development.
                        </p>
                        <div className="flex gap-4" aria-label="Social media links">
                            {socialLinks.map(({ label, href, Icon }) => (
                                <a
                                    ...
                                    className="flex items-center justify-center text-[#1B1D1E]/60 hover:text-[#1E5AA5] transition-colors duration-300"
                                >
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="space-y-4 font-medium text-[13px]">
                            ...
                            <li>
                                <Link to="/about" className="text-[#1B1D1E]/60 hover:text-[#1E5AA5] transition-colors">
                                    About Us
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/careers" className="text-[#1B1D1E]/60 hover:text-[#1E5AA5] transition-colors">
                                    Careers
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <ul className="space-y-5 font-medium text-[13px]">
                            ...
                            <li className="flex items-center">
                                <a href="tel:+13256670125" className="text-[#1B1D1E]/60 hover:text-[#1E5AA5] transition-colors">
                                    +1 325-667-0125
                                </a>
                            </li>
                        </ul>
                ...
                >
                    <p className="text-[#1B1D1E]/60 font-medium text-[13px] text-center sm:text-left">
                        &copy;{new Date().getFullYear()} Seanora Global. All Rights Reserved.
                    </p>
                    <div className="flex items-center gap-6">
                        <Link to="/privacy" className="text-[#1B1D1E]/60 font-medium text-[13px] hover:text-[#1E5AA5] transition-colors">
                            Privacy Policy
                        </Link>
                        <Link to="/terms" className="text-[#1B1D1E]/60 font-medium text-[13px] hover:text-[#1E5AA5] transition-colors">
                            Terms of Service
                        </Link>
                    </div>
                </m.div>
