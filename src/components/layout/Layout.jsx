    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-50 w-11 h-11 rounded-full bg-[#1B1D1E] text-white flex items-center justify-center shadow-[0_4px_24px_rgba(0,0,0,0.18)] hover:bg-[#1B1D1E]/80 transition-colors duration-200"
        >
