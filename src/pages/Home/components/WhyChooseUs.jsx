...
//                 {/* ── Scrolling track ───────────────────────────── */}
//                 <div className="flex-1 flex flex-col justify-center overflow-hidden">
//                     <m.div style={{ x, width: `${trackWidth}px` }} className="flex flex-col">
//                         {/* ROW 1 — Images */}
//                         <div
//                             className="flex items-end"
//                             style={{
...
//                                 />
//                             ))}
//                             <m.div className="absolute left-0 top-0 h-full bg-[#1E5AA5] rounded-full" style={{ width: barWidth }} />
//                         </div>
        ...
        <section ref={sectionRef} className="relative bg-[#F6F6F6] w-full" style={{ height: `${TOTAL_HEIGHT}vh` }}>
            ...
            <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col bg-[#F6F6F6]">
                ...
                <div className="flex-1 flex items-center px-[6vw] gap-12 xl:gap-16 min-h-0 py-8">
                    ...
                    <div
                        className="relative rounded-3xl overflow-hidden shrink-0 shadow-[0_24px_70px_-20px_rgba(0,0,0,0.22)] ring-1 ring-black/6 bg-white"
