...
/* CTA pill slide — absolute positioning so text/icon cross properly */
.cs-pill,
.cs-maps-pill {
  position: relative;
  overflow: hidden;
...
.cs-pill:hover .cs-pill-text        { transform: translateY(-50%) translateX(140px); }
.cs-pill:hover .cs-pill-icon        { transform: translateY(-50%) translateX(-130px); }
                                            ...
                                            <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                                                ...
                                                <div className="pt-2">
                                                    <button
                                                        type="submit"
                                                        disabled={isSubmitting}
                                                        className="cs-pill bg-gradient-to-r from-[#1E5AA5] to-[#29A8E0] text-white rounded-full w-[190px] h-[46px] disabled:opacity-60 disabled:cursor-not-allowed shadow-[0_4px_14px_rgba(30,90,165,0.35)]"
                                                    >
                                                        <span className="cs-pill-text text-[14px] font-medium">
                                                            {isSubmitting ? '…' : "Let's Collaborate"}
                                                        </span>
                                                        <div className="cs-pill-icon w-9 h-9 rounded-full bg-white text-[#1E5AA5] flex items-center justify-center">
                                                            <ArrowUpRight className="w-4 h-4" />
                                                        </div>
                                                    </button>
                                                </div>
